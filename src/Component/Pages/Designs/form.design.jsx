...
export default function DesignForm({
  ...
  const iro = (key) =>
    showForm === FORM_STATE.READ_ONLY || !designProperties[key]?.is_editable;
      ...
      >
        <Box>
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6} md={4}>
              ...
              {refImage.invalid && (
                <span className="error-text">Reference Image is required</span>
              )}
            </Grid>
            <Grid item xs={12} sm={6} md={4}>
              <Box sx={sx.image_container}>
        ...
        <Box marginTop="-10px">
          ...
          <CADTable
            ...
            cts={cadCts}
            setCts={setCadCts}
            hideActions={showForm === FORM_STATE.READ_ONLY}
          />
        </Box>
      </Box>
      {showForm !== FORM_STATE.READ_ONLY && (
